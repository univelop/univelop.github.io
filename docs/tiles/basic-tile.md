...
-   Liste freigeben: Ob die Liste samt Datensätzen mit weiteren Arbeitsbereichen geteilt werden soll, zum Beispiel für Stammdaten, die in mehreren Arbeitsbereichen benötigt werden. Alle Details unter [Geteilte Listen](/docs/tiles/shared-lists).
