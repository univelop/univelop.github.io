...
Um bei Prozessen zwischen mehreren Einträgen zu vereinfachen und die Nutzbarkeit für bspw. Portalnutzer zu verbessern, kann der Baustein *Navigation* genutzt werden. Dieser Baustein ist ein Button, welcher mit verschiedenen Navigationszielen versehen werden kann.
...
Liste ausgewäht. Dazu können Filter eingestellt werden, um die gezeigten Einträge der Liste zu beschränken.
...
Hier können zusätzlich Filter gesetzt werden, um den neuen Eintrag mit gewünschen Werten zu füllen.
