...
3. **Zeitzone** — die Zeitzone, die für die Anzeige und Berechnung von Datumswerten verwendet wird (Standard: Europe/Berlin)
4. **Arbeitsbereichstyp** — der Typ des Arbeitsbereichs (Produktion, Test, Entwurf, Solution)

## Arbeitsbereichstypen

| Typ | Beschreibung |
|---|---|
| **Produktion** | Standard-Arbeitsbereich für den produktiven Einsatz |
| **Test** | Testkopie eines Produktiv-Arbeitsbereichs |
| **Entwurf** | Demo-Arbeitsbereich, der nach 90 Tagen automatisch gelöscht wird |
