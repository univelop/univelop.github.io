...
2. **Inklusive* Nr** — Blendet das Feld für die Hausnummer ein oder aus. Standard: aktiviert.
...
4. **Adressbaustein** — Der Adress-Baustein, aus dem die Adresse übernommen wird. Nur verfügbar wenn _Adresse übernehmen_ aktiviert ist.
