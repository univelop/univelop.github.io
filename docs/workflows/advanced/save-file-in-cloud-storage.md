...
3. <span style="color:#0b5394">**Dateiname überschreiben oder ändern**</span>
   Optional kann der Dateiname vor dem Upload geändert werden. Wenn diese Option nicht aktiviert ist, wird der ursprüngliche Dateiname verwendet. Formeln können genutzt werden, um den Namen dynamisch zu setzen.
