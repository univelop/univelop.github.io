...
3. <span style="color:#0b5394">**Dateiname überschreiben oder ändern**</span>
   Optional kann der Dateiname vor dem Upload geändert werden. Wenn diese Option nicht aktiviert ist, wird der ursprüngliche Dateiname verwendet. Der Dateiname unterstützt das `${...}`-Format, z. B. `${project_title}-bericht.pdf`.
4. <span style="color:#0b5394">**Pfad**</span>
...
5. <span style="color:#0b5394">**Wenn Datei existiert**</span>
...
### <span style="color:#0b5394">**Dynamische Ordnerstrukturen**</span>

Du kannst Ordnerstrukturen dynamisch erzeugen, indem du sie direkt in der **Dateiname überschreiben oder ändern**-Formel (inkl. Unterordnern) definierst.
