...
[Baustein _Datum_](/docs/record-spec-settings/grand-childs-form/date.html)
...
**HINWEIS:** Keine eigenen Werte in die Klammer setzen (s. [Liste mit Standard-Datumsformeln](/docs/formulas/childs/date-formulas.html))
