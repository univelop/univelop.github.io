...
[Baustein _Team_](/docs/record-spec-settings/grand-childs-form/team.html)
...
-   <span style="color:#0b5394">**Meine**</span>  
     Sind Datensätze über den
    [Baustein _Benutzer_](/docs/record-spec-settings/grand-childs-form/user.html)
...
-   <span style="color:#0b5394">**Keine**</span>  
    ...
    [_Für Benutzerrollen anzeigen_](/docs/design-mode-settings.html#kachel)
...
Um lange Einträge mit vielen Bausteinen besser zu strukturieren, gibt es _Tabs_. Diese werden im [Designmodus für Einträge](/docs/design-mode-settings.html#eintrag) angeschaltet und konfiguriert.
